...
write.table(plsres, file="D:/mvc_bimonth_raw_3067/plsres_mam_mean_ncomp1.txt", row.names=FALSE, col.names=TRUE)
write.table(vip_v, file="D:/mvc_bimonth_raw_3067/vip_v_mam_mean_ncomp1.txt", row.names=FALSE, col.names=TRUE)
write.table(vip_loc, file="D:/mvc_bimonth_raw_3067/vip_loc_mam_mean_ncomp1.txt", row.names=FALSE, col.names=TRUE)
write.table(coefficients, file="D:/mvc_bimonth_raw_3067/coefficients_mam_mean_ncomp1.txt", row.names=FALSE, col.names=TRUE)
