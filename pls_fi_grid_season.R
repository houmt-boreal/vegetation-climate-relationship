...
write.table(plsres, file="D:/plsres_season.txt", row.names=FALSE, col.names=TRUE)
write.table(vip_v, file="D:/vip_v_season.txt", row.names=FALSE, col.names=TRUE)
write.table(vip_loc, file="D:/vip_loc_season.txt", row.names=FALSE, col.names=TRUE)
